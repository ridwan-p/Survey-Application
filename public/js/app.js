...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
	mode: "history",
	routes: [{ path: "/surveys", component: __webpack_require__(19) }, { path: "/surveys/create", component: __webpack_require__(47) }, { path: "/surveys/:id/edit", component: __webpack_require__(47), meta: { mode: "edit" } }, { path: "/surveys/:id", component: __webpack_require__(48) }]
});
...
Component.options.__file = "resources/js/view/surveys/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-172b20a0", Component.options)
  } else {
    hotAPI.reload("data-v-172b20a0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_request__ = __webpack_require__(21);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	beforeRouteEnter: function beforeRouteEnter(to, from, next) {
		__WEBPACK_IMPORTED_MODULE_0__utils_request__["a" /* default */].get("/surveys").then(function (res) {
			next(function (vm) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("li", { staticClass: "collection-item jc-between" }, [
        _c("h2", { staticClass: "collection-title" }, [
          _vm._v("Recent Surveys")
        ]),
        _vm._v(" "),
        _c(
          "button",
      ...
      _vm._v(" "),
      _vm._l(_vm.surveys.data, function(data) {
        return _c(
          "li",
          { staticClass: "collection-item" },
          [
            _c("router-link", { attrs: { to: "/surveys/" + data.id } }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-172b20a0", module.exports)
  }
}
...
Component.options.__file = "resources/js/view/surveys/form.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67abaf56", Component.options)
  } else {
    hotAPI.reload("data-v-67abaf56", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "resources/js/view/surveys/show.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-373db90f", Component.options)
  } else {
    hotAPI.reload("data-v-373db90f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "card-header" }, [
      _c("h3", { staticClass: "card-title" }, [
        _vm._v(_vm._s(_vm.title) + " Survey")
      ])
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "card-body d-flex flex-column" }, [
      ...
      _vm._v(" "),
      _c("div", { staticStyle: { "align-self": "flex-end" } }, [
        _c(
          "button",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-67abaf56", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	beforeRouteEnter: function beforeRouteEnter(to, from, next) {
		if (to.meta.mode === "edit") {
			var id = to.params.id;
			__WEBPACK_IMPORTED_MODULE_0__utils_request__["a" /* default */].get("/surveys/" + id).then(function (res) {
				next(function (vm) {
					return vm.setData(res);
				});
			});
	...
	methods: {
		...
		onSave: function onSave() {
			...
			Object(__WEBPACK_IMPORTED_MODULE_0__utils_request__["a" /* default */])(send).then(function (res) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "card-header" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "d-flex flex-row jc-between ai-center" }, [
        _c(
          "div",
          [
            _c("router-link", { attrs: { to: "" } }, [_vm._v("Take")]),
            _vm._v(" |\n                    "),
            _c(
              "router-link",
              { attrs: { to: "/surveys/" + _vm.modal.id + "/edit" } },
              [_vm._v("Edit")]
            ),
            _vm._v(" |\n                    "),
            _c("router-link", { attrs: { to: "" } }, [_vm._v("Answers")])
          ],
          1
        ),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-373db90f", module.exports)
  }
}
